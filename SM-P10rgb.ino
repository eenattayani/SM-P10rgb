...
#include <Fonts/Roboto_Bold_16.h>
#include <Fonts/Roboto_Bold_18.h>
#include <Fonts/Roboto_Bold_22.h>
#include <Fonts/Roboto_Bold_44.h>
#include <Fonts/DSEG7_Classic_Mini_Bold_14.h>
#include <Fonts/FreeMonoBold18pt7b.h>

#include <Fonts/Nimbus_Mono_L_Bold_24.h>
#include <Fonts/Nimbus_Sans_L_Bold_20.h>
#include <Fonts/Open_Sans_Condensed_Bold_20.h>
#include <Fonts/Orbitron_Bold_20.h>
#include <Fonts/Redressed_Regular_18.h>
#include <Fonts/Roboto_Slab_Bold_20.h>
#include <Fonts/URW_Gothic_L_Demi_20.h>
#include <Fonts/Monospaced_bold_18.h>
#include <Fonts/Lato_Bold_18.h>
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character          
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("h5 {text-align: left;}");
            ...
            client.println("input {border-raduis:8px; background-color: #eee; width: 100%; padding: 10px;}");
            client.println("</style></head>");
            
            // Web Page Heading
            client.println("<body><h1>Counter Down 1</h1>");
                       
            client.println("<p><h4>Running Text Merah</h4></p><hr>");
            ...
            client.println("<p><h4>Running Text Hijau</h4></p><hr>");
...
//  scrollingLayer.setFont(&Nimbus_Sans_L_Bold_20);
//  scrollingLayer.setFont(&Open_Sans_Condensed_Bold_20);
...
void font_huruf()
{
//  backgroundLayer.setFont(&Roboto_Bold_16); 
//  backgroundLayer.setFont(&Arimo_Regular_16);
//   backgroundLayer.setFont(&Crushed_Regular_16);
//    backgroundLayer.setFont(&DialogInput_bold_16);
//    backgroundLayer.setTextSize(2);
    backgroundLayer.setFont(gohufont11b);
//    backgroundLayer.setFont(font8x13);
//  backgroundLayer.setFont(&Roboto_Bold_18);  
//  display.setFont(&Roboto_Bold_20);
//  display.setFont(&Roboto_Bold_22);
//  backgroundLayer.setFont(&Roboto_18);
}
